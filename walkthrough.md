...
* **الملف المعدل**: [run-sync-and-preview.bat](file:///d:/I-Ai/App/Syrian%20community%20in%20the%20Netherlands/SGN/run-sync-and-preview.bat)
  ...
  * يقوم بالآتي بالترتيب:
    1. التحقق من السيرفر على منفذ 3000 (باستخدام `netstat` للبحث الدقيق عن المنفذ `:3000 ` مع استبعاد المنفذ المماثل `:30000`) وإطلاقه في نافذة مستقلة إذا لم يكن يعمل.
