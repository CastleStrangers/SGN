...
export default function ServicesDirectoryPage() {
  ...
  const smartTools = [
    {
      title: isRtl ? "قاريء ومترجم البوسطة" : isNl ? "Brieven Scanner (AI)" : "Brief Scanner (AI)",
      desc: isRtl ? "صوّر رسائل البلدية والضرائب وافهم المطلوب فوراً" : isNl ? "Brieven van Belastingdienst & CJIB" : "Understand official Dutch letters",
      href: "/services/brief-scanner",
      icon: Sparkles,
      color: "text-purple-600 bg-purple-50 dark:bg-purple-950/50 border-purple-200/50",
    },
    {
      title: isRtl ? "ظبّط سيرتك الذاتية (CV)" : isNl ? "Nederlands CV Maker" : "Dutch CV Builder",
      desc: isRtl ? "نماذج هولندية معتمدة ورسائل دافع للشركات" : isNl ? "Professioneel CV & Motivatiebrief" : "Standard Dutch resume & motivation letter",
      href: "/services/cv-builder",
      icon: FileText,
      color: "text-teal-600 bg-teal-50 dark:bg-teal-950/50 border-teal-200/50",
    },
    {
      title: isRtl ? "فرص شغل وتدريب بهولندا" : isNl ? "Vacatures & Stages" : "Jobs & Internships",
      desc: isRtl ? "شواغر عمل حية وتدريب مهني بتقديم سريع" : isNl ? "Actuele banen en stageplekken" : "Verified vacancies and internships",
      href: "/jobs",
      icon: Briefcase,
      color: "text-indigo-600 bg-indigo-50 dark:bg-indigo-950/50 border-indigo-200/50",
    },
    {
      title: isRtl ? "التحضير للـ Inburgering" : isNl ? "Inburgering Portaal" : "Inburgering Hub",
      desc: isRtl ? "بنك أسئلة وتدريب فوري لامتحانات الجنسية KNM" : isNl ? "Oefenexamens KNM, ONA & Taal" : "Practice exams for KNM & ONA",
      href: "/inburgering",
      icon: GraduationCap,
      color: "text-amber-600 bg-amber-50 dark:bg-amber-950/50 border-amber-200/50",
    },
    {
      title: isRtl ? "وين الجالية بهولندا؟" : isNl ? "Gemeenschapskaart" : "Community Map",
      desc: isRtl ? "مواقع مراكزنا والخصومات بالمقاطعات الـ ١٢" : isNl ? "Locaties in 12 provincies" : "Hubs across 12 provinces",
      href: "/map",
      icon: MapPin,
      color: "text-rose-600 bg-rose-50 dark:bg-rose-950/50 border-rose-200/50",
    },
    {
      title: isRtl ? "فزعة الجالية (ANBI)" : isNl ? "Solidariteitsfonds" : "Solidarity Fund",
      desc: isRtl ? "طوارئ، نقل جثامين، ومساندة أهلنا بشفافية" : isNl ? "Transparante noodhulp & ANBI" : "Transparent relief & aid",
      href: "/solidarity",
      icon: HeartHandshake,
      color: "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/50 border-emerald-200/50",
    },
    {
      title: isRtl ? "حاسبة التوسلاخ" : isNl ? "Toeslagen Calculator" : "Allowances Calculator",
      desc: isRtl ? "احسب إعانات السكن والتأمين لسنة ٢٠٢٦ ع الأكيد" : isNl ? "Zorgtoeslag, huur & kind" : "Health, rent & child allowances",
      href: "/services/toeslagen-calculator",
      icon: Calculator,
      color: "text-teal-600 bg-teal-50 dark:bg-teal-950/50 border-teal-200/50",
    },
    {
      title: isRtl ? "استشارات ولاد البلد" : isNl ? "Inloopspreekuur" : "Consultation Spreekuur",
      desc: isRtl ? "قعدة استشارة مع محامين ومحاسبين سوريين" : isNl ? "Juridisch en sociaal spreekuur" : "Legal & community clinic",
      href: "/spreekuur",
      icon: Scale,
      color: "text-blue-600 bg-blue-50 dark:bg-blue-950/50 border-blue-200/50",
    },
    {
      title: isRtl ? "حراج الجالية وعفش مجاني" : isNl ? "SGN Marktplaats" : "Community Marketplace",
      desc: isRtl ? "عفش مجاني للي طالعين عالبيوت ودليل الحرفيين" : isNl ? "Gratis meubels & vakmensen" : "Free furniture & craftsmen",
      href: "/marktplaats",
      icon: ShoppingBag,
