...
export default function ServicesDirectoryPage() {
  ...
  const smartTools = [
    ...
    {
      title: isRtl ? "صانع السيرة الذاتية (CV)" : isNl ? "Nederlands CV Maker" : "Dutch CV Builder",
      desc: isRtl ? "نماذج معتمدة ورسائل تحفيزية متوافقة مع سوق العمل الهولندي" : isNl ? "Professioneel CV & Motivatiebrief" : "Standard Dutch resume & motivation letter",
      href: "/services/cv-builder",
      icon: FileText,
      color: "text-teal-600 bg-teal-50 dark:bg-teal-950/50 border-teal-200/50",
    },
    {
      title: isRtl ? "الوظائف والتدريب المهني" : isNl ? "Vacatures & Stages" : "Jobs & Internships",
      desc: isRtl ? "شواغر عمل حية وفرص تدريب مهني مع تقديم مباشر" : isNl ? "Actuele banen en stageplekken" : "Verified vacancies and internships",
      href: "/jobs",
      icon: Briefcase,
      color: "text-indigo-600 bg-indigo-50 dark:bg-indigo-950/50 border-indigo-200/50",
    },
    {
      title: isRtl ? "بوابة التحضير للاندماج" : isNl ? "Inburgering Portaal" : "Inburgering Hub",
      desc: isRtl ? "بنك أسئلة وتدريب شامل لامتحانات الجنسية KNM واللغة" : isNl ? "Oefenexamens KNM, ONA & Taal" : "Practice exams for KNM & ONA",
      href: "/inburgering",
      icon: GraduationCap,
      color: "text-amber-600 bg-amber-50 dark:bg-amber-950/50 border-amber-200/50",
    },
    {
      title: isRtl ? "خريطة الجالية والمراكز" : isNl ? "Gemeenschapskaart" : "Community Map",
      desc: isRtl ? "دليل المقرات الخدمية وشبكة الخصومات في هولندا" : isNl ? "Locaties in 12 provincies" : "Hubs across 12 provinces",
      href: "/map",
      icon: MapPin,
      color: "text-rose-600 bg-rose-50 dark:bg-rose-950/50 border-rose-200/50",
    },
    {
      title: isRtl ? "صندوق التكافل والإغاثة (ANBI)" : isNl ? "Solidariteitsfonds" : "Solidarity Fund",
      desc: isRtl ? "مساندة الحالات الطارئة، نقل الجثامين، ودعم العائلات بشفافية" : isNl ? "Transparante noodhulp & ANBI" : "Transparent relief & aid",
      href: "/solidarity",
      icon: HeartHandshake,
      color: "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/50 border-emerald-200/50",
    },
    {
      title: isRtl ? "حاسبة المساعدات (Toeslagen)" : isNl ? "Toeslagen Calculator" : "Allowances Calculator",
      desc: isRtl ? "حساب مخصصات الإيجار، التأمين الصحي، ومساعدات الأطفال لعام ٢٠٢٦" : isNl ? "Zorgtoeslag, huur & kind" : "Health, rent & child allowances",
      href: "/services/toeslagen-calculator",
      icon: Calculator,
      color: "text-teal-600 bg-teal-50 dark:bg-teal-950/50 border-teal-200/50",
    },
    {
      title: isRtl ? "الاستشارات التخصصية (Spreekuur)" : isNl ? "Inloopspreekuur" : "Consultation Spreekuur",
      desc: isRtl ? "جلسات استشارة مباشرة مع خبراء قانونيين ومحاسبين معتمدين" : isNl ? "Juridisch en sociaal spreekuur" : "Legal & community clinic",
      href: "/spreekuur",
      icon: Scale,
      color: "text-blue-600 bg-blue-50 dark:bg-blue-950/50 border-blue-200/50",
    },
    {
      title: isRtl ? "سوق الجالية والأثاث المجاني" : isNl ? "SGN Marktplaats" : "Community Marketplace",
      desc: isRtl ? "أثاث مجاني ومستلزمات منزلية للقادمين الجدد ومنصة تبادل مجتمعية" : isNl ? "Gratis meubels & vakmensen" : "Free furniture & craftsmen",
      href: "/marktplaats",
      icon: ShoppingBag,
