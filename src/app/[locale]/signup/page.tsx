    ...
    <div className="min-h-screen flex" dir="rtl">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0f3d23] via-[#1a5632] to-[#2d7a4a] flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <h2 className="text-3xl font-bold mb-4">انضم إلى جالية السوريين</h2>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all text-sm font-semibold text-gray-700 disabled:opacity-60 disabled:cursor-not-allowed"
              >
