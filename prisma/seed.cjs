  ...
  const posts = [
    {
      ...
      content: "عقد وفد من الجالية السورية في هولندا اجتماعاً موسعاً مع مسؤولي بلدية أمستردام، ناقش خلاله سبل تحسين خدمات الإسكان والإقامة لأبناء الجالية.\n\nوجرى خلال الاجتماع الاتفاق على عدة مبادرات، من أبرزها:\n1. إنشاء مكتب استشارات قانونية مجاني لأبناء الجالية\n2. توفير دورات لغة هولندية مكثفة\n3. تسهيل إجراءات لم شمل العائلات\n\nوأكد رئيس الجالية على أهمية التعاون مع المؤسسات الهولندية لخدمة أبناء الجالية.",
