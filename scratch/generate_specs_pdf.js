...
<body>
  ...
  <h3>3.4 المساعد الذكي المتخصص (AI Assistant Persona Selector)</h3>
  ...
  <p>يعمل المساعد بتقنية <strong>RAG (الاسترجاع المعزز بالمعرفة)</strong> حيث يقوم بالبحث التلقائي في أخبار وفعاليات الجالية ومجلس الإدارة لتقديم إجابات موثقة وحقيقية من قاعدة بيانات المنصة.</p>
  ...
  <p>نظام محادثة فورية P2P مشفر وربط مباشر بين الأعضاء ومزودي الخدمات في الدليل، يدعم إرسال إشعارات فورية للهواتف (Push Notifications) عبر خوادم Expo للتنبيه بالرسائل الجديدة.</p>
